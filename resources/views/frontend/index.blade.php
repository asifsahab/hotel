                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <h1 class="display-3 text-white mb-4 animated slideInDown">Discover A Brand Luxurious Hotels</h1>
                                <a href="{{route('room')}}" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Our Rooms</a>
                    ...
                    <div class="row g-2">
                        <div class="col-md-10 ">
                            <div class="row g-2">
                                ...
                                <div class="col-md-4">
                                   <input type="number" placeholder="Enter Persons" class="form-control" name="persons">
                                </div>
                                <div class="col-md-4">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">Discover comfort and style at our hotels. Impeccable service, cozy rooms, and a touch of luxury. Choose from various options and enjoy collaborations with top hotels.</p>
        ...
        <div class="container-xxl testimonial my-5 py-5 bg-dark wow zoomIn" data-wow-delay="0.1s">
            <div class="container">
                <div class="owl-carousel testimonial-carousel py-5">
                    ...
                    <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
                        <p>Had a wonderful time at this hotel! The room was clean and comfortable, and the staff was incredibly friendly. Overall, a fantastic experience—highly recommend.</p>
                        <div class="d-flex align-items-center">
